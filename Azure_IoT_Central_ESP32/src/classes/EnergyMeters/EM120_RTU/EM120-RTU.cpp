...
EM120::EM120(int modbusId, int ctPrimary, int ctSecondary) :  modbusId(modbusId), ctPrimary(ctPrimary), ctSecondary(ctSecondary), comError(COM_OK){
...
void EM120::copyData(float* buffer, int bufferSize){
...
void EM120::getData(em3phData_t& payload){
