...
*/
static const int DIGITAL_PIN_SET_FLAGS_INDEX = FIRST_PULSE_ANALOG_DATA_INDEX;
static const int DIGITAL_PIN_SET_FLAGS_SIZE = FLAG_SIZE*NUM_MAX_DEVICES_EEPROM;

static const int DIGITAL_PIN_INDEX = DIGITAL_PIN_SET_FLAGS_INDEX + DIGITAL_PIN_SET_FLAGS_SIZE;
static const int DIGITAL_PIN_SIZE = PIN_SIZE*NUM_MAX_DEVICES_EEPROM;


static const int ANALOG_PIN_SET_FLAGS_INDEX = DIGITAL_PIN_INDEX + DIGITAL_PIN_SIZE;
static const int ANALOG_PIN_SET_FLAGS_SIZE = FLAG_SIZE*NUM_MAX_DEVICES_EEPROM;

static const int ANALOG_PIN_INDEX = ANALOG_PIN_SET_FLAGS_INDEX + ANALOG_PIN_SET_FLAGS_SIZE;
static const int ANALOG_PIN_SIZE = PIN_SIZE*NUM_MAX_DEVICES_EEPROM;



static const int CONVERSION_FACTOR_SET_FLAGS_INDEX = ANALOG_PIN_INDEX + ANALOG_PIN_SIZE;
