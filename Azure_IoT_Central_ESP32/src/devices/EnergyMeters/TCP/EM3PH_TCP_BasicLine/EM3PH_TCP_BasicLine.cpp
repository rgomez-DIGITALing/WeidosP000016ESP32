...
// EM3PH_TCP_BasicLine::EM3PH_TCP_BasicLine(uint8_t modbusId) : EM3PH_BaseClass(modbusId){}
EM3PH_TCP_BasicLine::EM3PH_TCP_BasicLine(ModbusTCPClient& client, IPAddress ipAddress) : _client(client), EM3PH_BaseClass(ipAddress){}
EM3PH_TCP_BasicLine::EM3PH_TCP_BasicLine(uint8_t modbusId, ModbusTCPClient& client, IPAddress ipAddress) : _client(client), EM3PH_BaseClass(modbusId, ipAddress){}

int EM3PH_TCP_BasicLine::begin(){
...
void EM3PH_TCP_BasicLine::stop(){
  _client.stop();
  return;
}

int EM3PH_TCP_BasicLine::update(){
...
void EM3PH_TCP_BasicLine::assignData(){
...
void EM3PH_TCP_BasicLine::assignData2(){
...
void EM3PH_TCP_BasicLine::assignData3(){
...
void EM3PH_TCP_BasicLine::computeValues(){
...
float EM3PH_TCP_BasicLine::getNextData(){
...
void EM3PH_TCP_BasicLine::updatePreviousValues(){
...
void EM3PH_TCP_BasicLine::setSkipVariables(){
