...
EM220::EM220(int modbusId, int ctPrimary, int ctSecondary) :  modbusId(modbusId), ctPrimary(ctPrimary), ctSecondary(ctSecondary), comError(COM_OK){
...
void EM220::copyData(float* buffer, int bufferSize){
