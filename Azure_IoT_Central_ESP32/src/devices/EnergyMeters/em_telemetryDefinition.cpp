...
char* EM1PH_PERIOD_DATA_TELEMETRY_NAMES[]{
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_TOTAL
};
...
char* EM3PH_DATA_TELEMETRY_NAMES[] = {
    ...
    TELEMETRY_PROP_NAME_ROT_FIELD,
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L1N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L2N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L3N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_L1N,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_L2N,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_L3N,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_L1N,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_L2N,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_L3N,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_L1N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_L2N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_L3N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_L1,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_L2,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_L3,
    TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_TOTAL,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_L1,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_L2,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_L3,
    TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_TOTAL
};
...
char* EM3PH_CONS_DELIV_DATA_TELEMETRY_NAMES[] = {
    TELEMETRY_PROP_NAME_REAL_ENERGY_CONS_L1N,
    TELEMETRY_PROP_NAME_REAL_ENERGY_CONS_L2N,
    TELEMETRY_PROP_NAME_REAL_ENERGY_CONS_L3N,
    TELEMETRY_PROP_NAME_REAL_ENERGY_CONS_TOTAL,
    TELEMETRY_PROP_NAME_REAL_ENERGY_DELIV_L1N,
    TELEMETRY_PROP_NAME_REAL_ENERGY_DELIV_L2N,
    TELEMETRY_PROP_NAME_REAL_ENERGY_DELIV_L3N,
    TELEMETRY_PROP_NAME_REAL_ENERGY_DELIV_TOTAL,
    TELEMETRY_PROP_NAME_REAL_ENERGY_SUM,
    TELEMETRY_PROP_NAME_REACTIVE_ENERGY_CONS_L1N,
    TELEMETRY_PROP_NAME_REACTIVE_ENERGY_CONS_L2N,
    TELEMETRY_PROP_NAME_REACTIVE_ENERGY_CONS_L3N,
    TELEMETRY_PROP_NAME_REACTIVE_ENERGY_DELIV_L1N,
    TELEMETRY_PROP_NAME_REACTIVE_ENERGY_DELIV_L2N,
    TELEMETRY_PROP_NAME_REACTIVE_ENERGY_DELIV_L3N,
};


char* EM3PH_PERIOD_DATA_TELEMETRY_NAMES[] = {
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L1N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L2N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L3N,
    TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_TOTAL,
...
char* TELEMETRY_PROP_NAME_REAL_ENERGY_CONS_L1N = "realEnergyConsL1";
char* TELEMETRY_PROP_NAME_REAL_ENERGY_CONS_L2N = "realEnergyConsL2";
char* TELEMETRY_PROP_NAME_REAL_ENERGY_CONS_L3N = "realEnergyConsL3";
char* TELEMETRY_PROP_NAME_REAL_ENERGY_CONS_TOTAL = "realEnergyConsTotal";
char* TELEMETRY_PROP_NAME_REAL_ENERGY_DELIV_L1N = "realEnergyDelivL1";
char* TELEMETRY_PROP_NAME_REAL_ENERGY_DELIV_L2N = "realEnergyDelivL2";
char* TELEMETRY_PROP_NAME_REAL_ENERGY_DELIV_L3N = "realEnergyDelivL3";
char* TELEMETRY_PROP_NAME_REAL_ENERGY_DELIV_TOTAL = "realEnergyDelivTotal";
char* TELEMETRY_PROP_NAME_REAL_ENERGY_SUM = "realEnergySum";

char* TELEMETRY_PROP_NAME_REACTIVE_ENERGY_CONS_L1N = "reactiveEnergyConsL1";
char* TELEMETRY_PROP_NAME_REACTIVE_ENERGY_CONS_L2N = "reactiveEnergyConsL2";
char* TELEMETRY_PROP_NAME_REACTIVE_ENERGY_CONS_L3N = "reactiveEnergyConsL3";
char* TELEMETRY_PROP_NAME_REACTIVE_ENERGY_CONS_TOTAL = "reactiveEnergyConsTotal";
char* TELEMETRY_PROP_NAME_REACTIVE_ENERGY_DELIV_L1N = "reactiveEnergyDelivL1";
char* TELEMETRY_PROP_NAME_REACTIVE_ENERGY_DELIV_L2N = "reactiveEnergyDelivL2";
char* TELEMETRY_PROP_NAME_REACTIVE_ENERGY_DELIV_L3N = "reactiveEnergyDelivL3";
char* TELEMETRY_PROP_NAME_REACTIVE_ENERGY_DELIV_TOTAL = "reactiveEnergyDelivTotal";
...
char* TELEMETRY_PROP_NAME_PERIOD_DATA_ERROR_COUNTER = "periodDataErrorCounter";
char* TELEMETRY_PROP_NAME_BACKUP = "backup";




char* TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L1N =  "periodRealPowerL1N";
char* TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L2N =  "periodRealPowerL2N";
char* TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_L3N =  "periodRealPowerL3N";
char* TELEMETRY_PROP_NAME_PERIOD_REAL_POWER_TOTAL =  "periodRealPowerTotal";
char* TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_L1N =  "periodApparentPowerL1N";
char* TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_L2N =  "periodApparentPowerL2N";
char* TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_L3N =  "periodApparentPowerL3N";
char* TELEMETRY_PROP_NAME_PERIOD_APPARENT_POWER_TOTAL =  "periodApparentPowerTotal";
char* TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_L1N =  "periodReactivePowerL1N";
char* TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_L2N =  "periodReactivePowerL2N";
char* TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_L3N =  "periodReactivePowerL3N";
char* TELEMETRY_PROP_NAME_PERIOD_REACTIVE_POWER_TOTAL =  "periodReactivePowerTotal";
char* TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_L1N =  "periodRealEnergyL1N";
char* TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_L2N =  "periodRealEnergyL2N";
char* TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_L3N =  "periodRealEnergyL3N";
char* TELEMETRY_PROP_NAME_PERIOD_REAL_ENERGY_TOTAL =  "periodRealEnergyTotal";
char* TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_L1 =  "periodApparentEnergyL1";
char* TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_L2 =  "periodApparentEnergyL2";
char* TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_L3 =  "periodApparentEnergyL3";
char* TELEMETRY_PROP_NAME_PERIOD_APPARENT_ENERGY_TOTAL =  "periodApparentEnergyTotal";
char* TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_L1 =  "periodReactiveEnergyL1";
char* TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_L2 =  "periodReactiveEnergyL2";
char* TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_L3 =  "periodReactiveEnergyL3";
char* TELEMETRY_PROP_NAME_PERIOD_REACTIVE_ENERGY_TOTAL =  "periodReactiveEnergyTotal";
