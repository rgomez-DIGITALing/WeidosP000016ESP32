...
//
  ...
  */
    ...
    uint32_t const  SD_CHIP_SELECT_PIN = SS;
  #else
    uint32_t const  SD_CHIP_SELECT_PIN = SDCARD_SS_PIN;
  #endif
...
class Sd2Card {
  public:
    ...
    */
    ...
    uint8_t init(uint8_t sckRateID, uint32_t chipSelectPin);
